...
function sendRequest() {
	...
	jQuery('#contactWrapper').append('<div class="success"><h4>Письмо успешно отправлено!</h4><br><p>Спасибо за использование нашей контактной формы <strong>'+decodeURIComponent(name)+'</strong>! Ваше письмо было успешно отправлено, и мы скоро свяжемся с вами.</p></div>');
	}
}
	...
	var errors=0;
	 ...
	 if($j('#contactform #name').val()=='') {
		...
		var hasClass=$j('#contactform #email').parent().find(".error").hasClass("error");
	 	if(!hasClass)
	 	    $j('#contactform #email').parent().append('<label for="contactname" generated="true" class="error">Пожалуйста, введите правильный адрес электронной почты</label>');	
		...
		var hasClass=$j('#contactform #subject').parent().find(".error").hasClass("error");
	 	if(!hasClass)
	 	    $j('#contactform #subject').parent().append('<label for="contactname" generated="true" class="error">Пожалуйста, напишите тему</label>');	
		...
		var hasClass=$j('#contactform #body').parent().find(".error").hasClass("error");
	 	if(!hasClass)
	 	    $j('#contactform #body').parent().append('<label for="contactname" generated="true" class="error">Напишите сообщение</label>');	
...
function check_values_booking() {
	...
	var errors=0;
	 ...
	 if($j('#contactform_booking #name').val()=='') {
	 	...
	 	if(!hasClass)
	 	    $j('#contactform_booking #name').parent().append('<label for="contactname" generated="true" class="error">Пожалуйста, введите правильный адрес электронной почты</label>');
		...
		var hasClass=$j('#contactform_booking #email').parent().find(".error").hasClass("error");
	 	if(!hasClass)
	 	    $j('#contactform_booking #email').parent().append('<label for="contactname" generated="true" class="error">Пожалуйста, введите правильный адрес электронной почты</label>');	
 ...
 if($j('#contactform_booking #rooms').val()=='') {
		...
		var hasClass=$j('#contactform_booking #body').parent().find(".error").hasClass("error");
	 	if(!hasClass)
	 	    $j('#contactform_booking #body').parent().append('<label for="contactname" generated="true" class="error">Напишите сообщение</label>');	
...
function check_values_popup() {
	...
	var errors=0;
	 ...
	 if($j('#contactform_popup #name_popup').val()=='') {
	 	...
	 	if(!hasClass)
	 	    $j('#contactform_popup #name_popup').parent().append('<label for="contactname" generated="true" class="error">Пожалуйста, введите правильный адрес электронной почты</label>');
		...
		var hasClass=$j('#contactform_popup #email_popup').parent().find(".error").hasClass("error");
	 	if(!hasClass)
	 	    $j('#contactform_popup #email_popup').parent().append('<label for="contactname" generated="true" class="error">Пожалуйста, введите правильный адрес электронной почты</label>');	
		...
		var hasClass=$j('#contactform_popup #subject_popup').parent().find(".error").hasClass("error");
	 	if(!hasClass)
	 	    $j('#contactform_popup #subject_popup').parent().append('<label for="contactname" generated="true" class="error">Пожалуйста, напишите тему</label>');	
		...
		var hasClass=$j('#contactform_popup #body_popup').parent().find(".error").hasClass("error");
	 	if(!hasClass)
	 	    $j('#contactform_popup #body_popup').parent().append('<label for="contactname" generated="true" class="error">Напишите сообщение</label>');	
...
function check_values_news() {
	...
	var errors=0;
	 ...
	 if($j('#newsletterform #name_news').val()=='') {
	 	...
	 	if(!hasClass)
	 	    $j('#newsletterform #name_news').parent().append('<label for="contactname" generated="true" class="error">Пожалуйста, введите правильный адрес электронной почты</label>');
		...
		var hasClass=$j('#newsletterform #email_news').parent().find(".error").hasClass("error");
	 	if(!hasClass)
	 	    $j('#newsletterform #email_news').parent().append('<label for="contactname" generated="true" class="error">Пожалуйста, введите правильный адрес электронной почты</label>');	
